...
def nautobot_database_ready_callback(sender, *, apps, **kwargs):
    ...
    #     name="{{ cookiecutter.project_name }}_auto_custom_field",  # Effectively a slug, will go away in a future Nautobot release
    #     slug="{{ cookiecutter.project_name }}_auto_custom_field",  # Note underscores rather than dashes!
    #     defaults={
    #         "type": CustomFieldTypeChoices.TYPE_TEXT,
    #         "label": "{{ cookiecutter.project_name }} Automatically Added Custom Field",
